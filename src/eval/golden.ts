...
/** A saved set of tasks for reproducible comparisons: `golden/<bundle>/<name>.yaml`. */
...
/** The last `limit` distinct real tasks of a bundle (answered, not replays), oldest first. */
