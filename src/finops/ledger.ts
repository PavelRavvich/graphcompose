...
/**
 * Daily spend of one agent bundle (config.name). Days are UTC: the counter resets at 00:00 UTC.
...
/** Spend allowed for one run: the run cap ∩ what is left of the bundle's daily cap. */
...
/** Append-only JSONL, one file per bundle per UTC day: <dir>/<bundle>/<YYYY-MM-DD>.jsonl. */
